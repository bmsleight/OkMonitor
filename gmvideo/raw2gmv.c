...
int main(void) {
    u8 o,to,tb,wb0[1024*758]; u32 x,y,xi,yi,c=250,b=120; // c=contrast, b=brightness
    while (fread(wb0,1024*758,1,stdin)) for (y=0;y<1024;y++) { xi=y; tb=0;
        for (x=0;x<758;x++) { yi=757-x; o=x^y;
